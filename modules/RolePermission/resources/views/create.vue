...
<template>
  ...
  <AppLayout>
    <c-page-header title="Tambah Role Baru" :breadcrumbs="[{ label: 'Role & Permission', href: route('roles.index') }, { label: 'Tambah Role' }]" />
    ...
    <form @submit.prevent="submit">
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              <c-input id="name" v-model="form.name" label="Nama Role" placeholder="Masukkan nama role (slug)" :error="form.errors.name" required />
            </div>
            <div class="col-md-6">
            ...
            <table class="table table-bordered table-hover mb-0">
              ...
              <tbody>
                <tr v-for="module in modules" :key="module.id">
                  ...
                  <td class="text-center"><input type="checkbox" class="form-check-input" :checked="isAllCheckedForModule(module.id)" @change="toggleAllForModule(module.id)"></td>
                  <td v-for="action in actions" :key="action" class="text-center"><input type="checkbox" class="form-check-input" :checked="hasPermission(module.id, action)" @change="togglePermission(module.id, action)"></td>
                </tr>
