...
<template>
  ...
  <AppLayout>
    <c-page-header :title="`Edit User: ${user.name}`" :breadcrumbs="[{ label: 'User Management', href: route('users.index') }, { label: 'Edit User' }]" />
      ...
      <div class="card-body">
        <form @submit.prevent="submit">
          <div class="row">
            ...
            <div class="col-md-6">
              <c-input id="password" v-model="form.password" label="Password Baru" placeholder="Kosongkan jika tidak ingin mengubah" :error="form.errors.password" password-toggle />
            </div>
            <div class="col-md-6">
              <c-input id="password_confirmation" v-model="form.password_confirmation" label="Konfirmasi Password" placeholder="Ulangi password baru" password-toggle />
            </div>
            <div class="col-md-6">
