...
const submit = () => form.post(route('modules.store'))
</script>
...
<template>
  ...
  <AppLayout>
    <c-page-header title="Add New Module" :breadcrumbs="[{ label: 'Settings', href: route('modules.index') }, { label: 'Module Management', href: route('modules.index') }, { label: 'Add Module' }]" />
    ...
    <form @submit.prevent="submit">
      ...
      <div class="d-flex gap-2 justify-content-end">
        ...
        <c-button type="submit" variant="primary" :loading="form.processing">Save</c-button>
      </div>
    </form>
  </AppLayout>
</template>
